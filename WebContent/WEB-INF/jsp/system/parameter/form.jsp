...
<head>
    ...
    <div style="height: 100%;margin-bottom: 20px">
        <div class="controls-row" style="margin-top: 20px">
            ...
            <div class="control-group span5">
                <label class="control-label" for="startDate">有效时间（起止）:<b id="dateFormat" style="color: red">（例：<c:out value="${reportList[0].DEFINE1}"></c:out>）</b></label>
                <div class="controls controls-row">
                    ...
                    <input type="text" name="endDate" id="endDate" size="60" class="span2" placeholder="结束日期" style="margin-left: 0">
                </div>
            </div>
    ...
    <div class="controls-row" style="margin-top: 20px;position: relative">
        ...
        <input type="button" class="btn btn-mini btn-primary span1" value="提交" style="position:absolute;bottom:19%;" onclick="checkandsubmit()">
