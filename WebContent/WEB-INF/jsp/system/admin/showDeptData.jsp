...
.nature {
	...
	font-size: 15px;
	font-weight:bold;
	background: url(static/navigation/assets/images/nature/img1.png)
		no-repeat;
	cursor: pointer;
	position: relative;
}
...
.hp_title{color:#3f3f3f; font-size:18px; font-weight:bold; margin-left:15px; margin-top:30px;}
</style>
</head>
...
<body>
	<div class="page-content">
		<div class="row" style="margin:0;">
			...
			<div class="hp_title" style="font-style:‘微软雅黑’"><!-- 司太立制药 -->组织架构图</div>
			...
			$.ajax({
				...
				success:function (data){     //回调函数，result，返回值
					...
					$.each(obj.list, function(i, list){
						...
						str += '</div></div></li>';
						var deptstr = '<li><div class="mysocialshare bubble"><a class="msb_main" id='+list.BIANMA+'>'+list.NAME+'</a><div class="msb_network_holder">';
					...
					$(this).addClass("disabled").delay(s).queue(function(e){
						...
						e()
							...
							$(n).next().find(".msb_network_button").each(function(){
								var n=(i*k)+150-lileft+60;
								var r=Math.floor((o-1)/5)*50-litop-50//-aa;
								$(this).css({display:"block",left:p+"px",top:d+"px"}).stop().animate({left:n+"px",top:r+"px",opacity:"1"},e);
								o++;
								k++;
								if((k-1)%5===0){
									k=1;
	...
	<!-- <script src="static/navigation/assets/js/MySocialShare.js"
		type="text/javascript"></script> -->
	<script src="static/navigation/assets/js/mobilyblocks_change.js"
		type="text/javascript"></script>
