		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group normal_text">
					<h3>
						<!-- <img src="static/login/logo.png" alt="Logo" /> -->江苏东成-人单合一
					</h3>
				</div>
					...
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg"><i><img height="37"
								...
								name="loginname" id="loginname" value="admin"
								placeholder="请输入用户名" />
						</div>
					</div>
				</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">版权所有 &copy; 2015   研发中心</span></font>
				</div>
			</div>
			<div>
			</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq12345678mfw"+loginname+",mfw,"+password+"QQ98765423mfw";
				$.ajax({
					type: "POST",
