		...
		<div >
		    ...
		    <div id="more" class="more">
				...
				<table style="width: 100%;margin-top: 5px;">
					...
					<tr>
						<td colspan="2">
							<a class='btn btn-mini btn-primary' style="margin-top: 10px;margin-bottom:10px;margin-left: 220px;" onclick="toSearch();">查询</a>
							<a class='btn btn-mini btn-primary' style="cursor: pointer;margin-left: 10px;" onclick="emptySearch();">重置</a>
						</td>
					</tr>
				</table>
				</form>
							...
							<c:when test="${EMP_CODE == per.EMP_CODE}">
								...
								<table style="width:100%;">
									<tr>
										...
										<td class="wordlimit">
											<label>员工姓名：</label><span style="color:blue">${per.EMP_NAME }</span>
										</td>
									</tr>
									<tr>
										<td class="wordlimit">
