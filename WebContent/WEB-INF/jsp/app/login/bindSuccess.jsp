...
<html>
  <head>
	...
	<body>
		<img src="static/login_stl/images/bundling-success.png" width="100%" />
		<div style="text-align:center;line-height:2;font-size:16px;">
			<span style="color:#0c9e2b;">已绑定账号</span>
			<p style="color:#727272; text-decoration:underline;">${pd.USERNAME }</p>
		</div>
		<div style="height:50px;"></div>
 		<div style="width:70%; margin:0 auto;">
			<button id = "complete" type="button" class="btn btn-info btn-unbuding" onclick="close()">完  成</button>
		</div>
