		...
		function save(){
			...
			var options = {
				success: function(data){
					alert("保存成功");
					$("#zhongxin").hide();
				    var url = '<%=basePath%>app_task/listCreativeEmpTask.do?show=${pd.show}&showDept=${pd.showDept}&loadType=${pd.loadType }&startDate=${pd.startDate }&endDate=${pd.endDate }&projectCode=${pd.projectCode }&eventId=${pd.projectEventId }&deptCode=${pd.deptCode }&empCode=${pd.empCode }';
...
<%-- 		<div class="back" style="top:5px">
			<a href="<%=basePath%>app_task/listCreativeEmpTask.do?show=${pd.show}&showDept=${pd.showDept}&loadType=${pd.loadType }&startDate=${pd.startDate }&endDate=${pd.endDate }&projectCode=${pd.projectCode }&eventId=${pd.projectEventId }&deptCode=${pd.deptCode }&empCode=${pd.empCode }">
