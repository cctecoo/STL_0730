...
<%-- 		<div class="back" style="top:5px">
 ...
 <div id="normal" class="normal" style="width: 100%;">
	<div style="right:5px;">
            <div>
            	<c:if test="${taskStatus=='YW_CG'|| taskStatus=='YW_YTH' }">
     ...
     <table class="table table-striped table-bordered table-hover" id="timeTable">
         ...
         <tbody>
             ...
             <tr>
                 ...
                 <td>
                     <input type="text" name="start_time" style="width:50%;background:#fff!important;" value="${time.start_time}" onchange="changeTime()"
                            class="date-picker" data-date-format="hh:ii" placeholder="请输入时间！" />
                 </td>
                 <td>
                     <input type="text" name="end_time" style="width:50%;background:#fff!important;" value="${time.end_time}" onchange="changeTime()"
                            class="date-picker" data-date-format="hh:ii" placeholder="请输入时间！" />
                 </td>
             </tr>
             </c:forEach>
...
<script type="text/javascript">
    $(function() {
    	if('${taskStatus}'=='YW_CG'|| '${taskStatus}'=='YW_YTH'){
    		//时间框
            initDateInput();
    	}
