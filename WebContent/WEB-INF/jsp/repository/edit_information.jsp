...
<body>
	...
	<form action="repository/saveEditInformation.do" name="repositoryForm" id="repositoryForm" method="post">
		...
		<div id="zhongxin">
			<table style="margin-left: 40px;"><br>
				...
				<tr>
		        	...
		        	<td>
		        		<input type="text" id="EMP_NAME" readonly="readonly" style="background: #fff!important;" 
		        			onclick="showDeptTree(this)" value="${pd.selectedDeptNames}"/>
