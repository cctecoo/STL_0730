...
<body>
	<form action="dept/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%; margin:0 auto;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/dept/downExcel.do'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
