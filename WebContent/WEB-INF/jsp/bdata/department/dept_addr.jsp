	...
	<form action="dept/${msg}.do" name="deptForm" id="deptForm" method="post">
		...
		<table>
			...
			<tr>
				...
				<td><input value="${pd.DEPT_LEADER_NAME}" type="text" name="DEPT_LEADER_NAME" id="DEPT_LEADER_NAME" style="background:white!important;" readonly="readonly" onclick="deptAndEmp()"/>
			</tr>
			<tr>
