...
<html lang="en">
	<head>
		...
		td>label{text-align:right; margin-right:8px;}
	...
	<form action="dept/${msg}.do" name="deptForm" id="deptForm" method="post">
		...
		<table>
			<tr>
				...
				<td><input type="text" name="DEPT_CODE" id="dept_code" value="" maxlength="32" placeholder="这里输入部门编码" title="部门编码" /></td>
			</tr>
			<tr>
				<td style="height:40px;"><label><span style="color:red">*</span>部门名称：</label></td>
				<td><input type="text" name="DEPT_NAME" id="dept_name" value="" maxlength="32" placeholder="这里输入部门名称" title="部门名称" /></td>
			</tr>
			<tr>
				<td style="height:40px;"><label><span style="color:red">*</span>部门标识：</label></td>
				<td><input type="text" name="DEPT_SIGN" id="dept_sign" value="" maxlength="32" placeholder="这里输入部门标识" title="部门标识"/></td>
			</tr>
			<tr>
				<td style="height:40px;"><label>上一级部门：</label></td>
				<td><input type="text" id="parent_name" value="${pd.DEPT_NAME }" maxlength="32" title="上一级部门" readonly/>
					<input type="hidden" name="PARENT_ID" id="parent_id" value="${pd.ID }" title="上一级ID" readonly/></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="height:40px;"><label>所属分公司：</label></td>
