...
<body>
		<form action="positionLevel/add.do" name="form1" id="form1"  method="post">
			...
			<table>
				<tr>
					<td><label><span style="color: red">*</span>岗位编码：</label></td>
					<td><input type="text" name="gradeCode" id="gradeCode" title="岗位编码"/></td>
				</tr>
				<tr>
					<td><label><span style="color: red">*</span>岗位名称：</label></td>
					<td><input type="text" name="gradeName" id="gradeName" title="岗位名称"/></td>
				</tr>
				<tr>
					<td><label><span style="color: red">*</span>岗位等级：</label></td>
					<td><input type="text" name="jobRank" id="jobRank" placeholder="输入岗位等级" title="岗位等级" 
						value="15" style="ime-mode:disabled" 
				...
				<tr>
					...
					<td><input type="text" name="gradeDesc" id="gradeDesc" placeholder="这里输入岗位描述" title="描述"/></td>
				</tr>
