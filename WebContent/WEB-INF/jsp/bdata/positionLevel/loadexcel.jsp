...
<body>
	...
	<form action="positionLevel/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data" >
		<div id="zhongxin">
		<table style="width:95%;margin:0 auto;" >
			...
			<tr>
				<td style="text-align: center;padding-top: 10px;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/positionLevel/downExcel.do'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
