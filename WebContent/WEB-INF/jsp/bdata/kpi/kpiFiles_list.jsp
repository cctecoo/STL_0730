...
<!--树状图插件 -->
   ...
   <!--  <link rel="stylesheet" href="static/assets/css/ace.css" class="ace-main-stylesheet" id="main-ace-style" /> -->
	...
	$(function(){	
		...
		$("div.main-container-left").css("height",browser_height*0.45);
		$(window).resize(function() { 
			var browser_height = $(window).height();
			$("div.main-container-left").css("height",browser_height*0.9);
		}); 
		});
	</script>
	...
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			...
			<form action="kpiFiles/list.do" method="post" name="kpiFilesForm" id="kpiFilesForm">
				...
				<!-- 左侧指标库 -->
				<div id="kpiListDiv" style="float: left; width:550px; ">
					<div class="m-c-l-top">
					...
					<div class="left" style="height: 550px;">
						<script type="text/javascript">
					        ...
					        <c:forEach items="${dtreeList}" var="var" varStatus="vs">
					        	varList.add(${var.ID},${var.PARENT_ID},'[${var.CODE}]${var.NAME}','kpiFiles/list.do?ID=${var.ID}',
					        			'${var.NAME}','','','',true);
					        </c:forEach>
				...
				<!-- 右侧指标信息 -->
				<div id="kpiInfoDiv" class="main-content" style="margin-left: 551px;">
					...
					<table id="table_report" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<c:if test="${not empty pd }">
								...
								<tr>
									<th>KPI名称</th>
									<td colspan="4">${pd.KPI_NAME}</td>
								</tr>
								<tr>
									<th>指标描述</th>
									<td colspan="4">${pd.KPI_DESCRIPTION}</td>
								</tr>
								<tr>
									<th>KPI计算逻辑</th>
									<td colspan="4">${pd.KPI_SQL}</td>
								</tr>
							</c:if>
