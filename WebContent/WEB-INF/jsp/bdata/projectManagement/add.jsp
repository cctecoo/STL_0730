				...
				<div class="row" >
					<div class="col-xs-12" style="margin-left:30px;">
						<div style="margin:10px;">
							<div>
								<label>公式名称:</label>
								<input id="formulaName" type="text" name="formulaName" value="" style="margin:0 10px; width:300px" maxlength="50"/>
							</div>
							<div style="margin-top:10px; ">
								<label>适用类型:</label>
								<input class="formulaType" type="radio" name="formulaType" value="productLine" />产线经理等管理人员
								<input class="formulaType" type="radio" name="formulaType" value="dept" />车间主任等管理人员
								<input class="formulaType" type="radio" name="formulaType" value="baseEmp" checked="checked" />车间工人等基层人员
							</div>
						</div>
		...
		function saveProject(){
			...
			*/
			...
			top.Dialog.confirm("保存当前方案?",function(){
				...
				var url = "<%=basePath%>projectManagement/add.do?addInfo="+encodeURI(encodeURIComponent(info))
