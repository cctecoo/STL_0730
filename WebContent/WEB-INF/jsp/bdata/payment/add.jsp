...
<body>
	<form action="payment/add.do" name="targetForm" id="targetForm"
		method="post">
		<div id="zhongxin">
			<table style="margin-left: 40px;">
				...
				<tr>
					<td><label><span style="color: red;">*</span>显示名称:</label></td>
					<td><input type="text" id="NAME"
						name="NAME" style="background:#fff!important;" maxlength="50" /></td>
				</tr>
				<tr>
					<td><label><span style="color: red;">*</span>唯一标识:</label></td>
					<td><input type="text" id="ITEM_NAME"
						name="ITEM_NAME" style="background:#fff!important;" maxlength="50" /></td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		function save() {
			...
			if (null == $("#ITEM_NAME").val() || "" == $("#ITEM_NAME").val()) {
				$("#ITEM_NAME").tips({
					side : 3,
					msg : "请填写!",
					bg : "#AE81FF",
