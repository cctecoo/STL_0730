	...
	<input type="hidden" id="oldName" value="${pd.detail }" />
		...
		<table style="margin:0 auto;">
			<tr>
				...
				<td style="text-align: left;" ><input type="text" name="detail" id="detail" value="${pd.detail}" style="color:black;" maxlength="255"/></td>
			</tr>
			<tr>
				<td style="text-align: center;">要求：</td>
				<td style="text-align: left;" ><input type="text" name="requirement" id="requirement" value="${pd.requirement}" style="color:black;" maxlength="255"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align: left;" ><input type="text" name="frequency" id="frequency" style="color:black;" value="${pd.frequency}" maxlength="500"/></td>
			</tr>
			<tr>
				<td style="text-align: center;">工作指南：</td>
				<td style="text-align: left;" ><input type="text" name="guide" id="guide" value="${pd.guide}" style="color:black;"  maxlength="255"/></td>
			</tr>
			<tr>
				<td style="text-align: center;">对象：</td>
				<td style="text-align: left;" ><input type="text" name="target" id="target" value="${pd.target}" style="color:black;" maxlength="32"/></td>
			</tr>
			<tr>
