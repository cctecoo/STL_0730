					...
					<tr>
						...
						<td>
							<input type="text" id="birthday" name="BIRTHDAY" style="background:#fff!important;" 
                            	class="date-picker" data-date-format="yyyy-mm-dd" placeholder="请输入年月日！" value="${emp.BIRTHDAY }" onchange="jsGetAge()" readonly="readonly"/>
						</td>
						<td style="padding-left: 30px;">
							<label>员工性别：</label>
						</td>
					...
					<tr>
						...
						<td>
							<input type="text" name="AGE" id="age" 
							        value=""
								    maxlength="32" placeholder="年龄" title="年龄" readonly/>
						</td>
						<td style="padding-left: 30px;">
							<label>籍&nbsp;贯：</label>
						</td>
					...
					<tr>
						...
						<td>
							<input type="text" id="graduate_time" name="GRADUATE_TIME" style="background:#fff!important;" 
                            	class="date-picker" data-date-format="yyyy-mm-dd" placeholder="请输入年月日！" value="${emp.GRADUATE_TIME }" readonly="readonly"/>
						</td>
						<td style="padding-left: 30px;">
							<label>学&nbsp;位：</label>
						</td>
		        ...
		        <div class="row">
		            <div class="span12">
		                ...
		                <div class="span5" style="text-align: right">
		                    <h4>
		                        <a style="cursor:pointer;" title="添加工作经历" onclick="add()" class='btn btn-small btn-info' data-rel="tooltip" data-placement="left">
		                            <i class="icon-book"></i>
		                        </a>
		                        <a style="cursor:pointer;" title="删除工作经历" onclick="del()" class='btn btn-small btn-danger' data-rel="tooltip" data-placement="left">
