						...
						<td>
							<select id="EMP_GRADE_ID" name="EMP_GRADE_ID">
								...
								<c:forEach items="${levelList }" var="level">
									<option value="${level.ID }" <c:if test="${emp.EMP_GRADE_ID == level.ID}">selected</c:if> >
										${level.GRADE_NAME }
									</option>
								</c:forEach>
							</select>
						...
						<td>
							<select id="EMP_POSITION_CODE" name="EMP_POSITION_CODE" >
								...
								<c:forEach items="${posList }" var="pos" varStatus="vs">
									<option value="${pos.POSITION_CODE}" <c:if test="${pos.POSITION_CODE == emp.EMP_POSITION_CODE}">selected</c:if> >
										${pos.POSITION_NAME}
									</option>
								</c:forEach>
							</select>
						...
						<td style="display:none">
							<select id="ATTACH_KPI_MODEL" name="ATTACH_KPI_MODEL" onchange="javascript:SelectModelChange();">
								...
								<c:forEach items="${kpiModelList }" var="kpiMode" varStatus="vs">
									<option value="${kpiMode.ID}" <c:if test="${kpiMode.ID == emp.ATTACH_KPI_MODEL}">selected</c:if> >
										${kpiMode.NAME}
									</option>
								</c:forEach>
							</select>
