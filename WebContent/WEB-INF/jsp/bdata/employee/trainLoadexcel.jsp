	...
	<head>
		...
		<script type="text/javascript">
			...
			function save(){
				...
				top.Dialog.confirm('此操作将覆盖原有的记录，确定继续操作？', function(){
					$("#Form").submit();
					$("#zhongxin").hide();
					$("#zhongxin2").show();
				});
...
<body>
	...
	<form action="empTrain/readExcelTrain.do" name="Form" id="Form" method="post" enctype="multipart/form-data" >
		<div id="zhongxin">
		<table style="width:95%;margin:0 auto;" >
			...
			<tr>
				<td style="text-align: center;padding-top: 10px;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/empTrain/downExcelTrain.do'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
