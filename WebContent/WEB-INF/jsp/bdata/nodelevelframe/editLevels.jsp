							...
							<table width="100%" style="margin:3px 0 5px 0" id="dimtable">
								...
								<tr style="background-color: rgb(248,248,248);">
									...
									<td>
										...
										<input type="text" name="level" id="level" value="${key.LEVEL}" onkeyup="changeNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
									</td>
									<td>
										<select name="projectNodeLevel" style="width: 100%;">
											<c:forEach items="${nodeList}" var="var" varStatus="vs">
												<option value="${var.ID}" <c:if test="${var.ID == key.PROJECT_NODE_LEVEL_ID}">selected="selected"</c:if>>${var.NODE_LEVEL}</option>
											</c:forEach>
										</select>
									</td>
						...
						<table id="dimString" style="display: none;">
							<tr style="background-color: rgb(248,248,248);">
									...
									<td>
										...
										<input type="text" name="level" id="level" onkeyup="changeNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
									</td>
									<td>
										<select name="projectNodeLevel" style="width: 100%;">
											<c:forEach items="${nodeList}" var="var" varStatus="vs">
