...
<html lang="zh_CN">
	...
	<body>
		<form action="nodeLevelFrame/edit.do" name="form1" id="form1"
			method="post">
				...
				<table>
					<tr>
						...
						<td><input type="text" name="levelFrame" id="levelFrame"
							placeholder="这里输入节点层级结构名称" maxlength="255" title="节点层级结构"
							value="${pd.LEVEL_FRAME }" /></td>
					</tr>
					<tr>
						<td><label>描述：</label></td>
						<td><input type="text" name="descp" id="descp"
							placeholder="这里输入描述" title="描述" maxlength="255" value="${pd.DESCP }"></td>
					</tr>
					<tr>
