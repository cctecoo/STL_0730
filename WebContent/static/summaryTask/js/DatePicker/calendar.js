...
(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<div class="calendar-hd">',
            '<a data-calendar-display-month class="calendar-display">{yyyy}</a>',
            '<div class="calendar-arrow">',
    ...
    Calendar.prototype = {
        ...
        getDayItem: function(y, m, d, f) {
            ...
            if (f === 1) {
                ...
                data['class'] = '';
                //设置日期的背景色
                var dayType = this.getDayType(idt);
                if(dayType ){
                	data['class'] += ' ' + dayType;
                }
            }

            if(this.options.isSelectToday){
            	if (dt.isSame(y, m, d)) {
        ...
        selectedDay: function(d, type) {
            var arr = this.getDisDateValue(),
                ...
                toggleClass = function() {
                	...
                	this.options.selectedDay.call(this, d, type);
                };
        ...
        event: function() {
            ...
            _this.$element.on('click', ARROW_DATE, function() {
                ...
                var d = _this.updateDateView(y, m, type, function() {
                    vc('date', d.y, d.m);
                    _this.options.clickArrowDate.call(this, type, y, m);
                });
            ...
            _this.$element.on('mouseenter', '[' + ITEM_DAY + ']', function(e) {
                ...
                var	dayCls = $(this).attr('class');
                if (_this.hasLabel && $(this).data(MARK_DATA) && 'old'!=dayCls && 'new'!=dayCls) {
