 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',mfw,' + dtype + ',mfw,' + dbz + ',mfw,' + isQian + ',mfw,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',mfw,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',mfw,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',mfw,')[0];
			if(array0 == value){
				return false;
			}
		}
