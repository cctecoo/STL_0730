...
(function($){
	...
	$.fn.createTableListener = function() {
		...
		$(".add-field").click(function(){
            ...
            "<td style=\"width: 150px;\"><div class=\"col-sm-12 p-l-0 p-r-0\"><select class=\"cnoj-select field-type form-control input-sm\" data-uri=\"dictItem.do?busiValue=TABLE_FIELD_DATA_FORMAT\" style=\"width: 140px;\" name=\"fields["+(seqNum-1)+"].dataFormat\"></select></div></td>"+
            ...
            "<td><input type=\"text\" id=\"field-remark"+seqNum+"\" class=\"form-control require input-sm\" name=\"fields["+(seqNum-1)+"].fieldRemark\" /></td>"+
            "<td id=\"del"+seqNum+"\"></td>"+
            "</tr>";
        ...
        function _fieldTypeListner() {
            $(".field-type").on('change',function () {
                ...
                $fieldLen.attr('data-regexp',null);
