...
UE.plugins['file'] = function () {
	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/file.html',
				name:thePlugins,
				editor:this,
				title: '上传文件',
...
UE.plugins['files'] = function () {
	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/files.html',
				name:thePlugins,
				editor:this,
				title: '上传文件插件',
				cssRules:"width:700px;height:400px;",
...
UE.plugins['helpers'] = function () {
	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/helpers.html',
				name:thePlugins,
				editor:this,
				title: '文本框',
    ...
    editor.registerCommand(uiName,{
        execCommand:function(){
            try {
               ...
               // alert('formDesign.fnCheckForm("save") 保存异常'+e);
                throw e;
            }
