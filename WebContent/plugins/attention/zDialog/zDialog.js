...
Dialog.prototype.create = function() {
    ...
    if (this.InvokeElementId) {
        ...
        if(null == d){
            d = document.getElementById('_DialogFrame_0').contentWindow.document.getElementById(this.InvokeElementId);
        }
        d.style.position = "";
        d.style.display = "";
        if (isIE) {
