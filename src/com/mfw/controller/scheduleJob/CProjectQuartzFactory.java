 ...
 * 协同工作-定时任务
 * @author  作者 白惠文
 * @date 创建时间：2017年6月29日 下午17:22:32
 */
@Service
public class CProjectQuartzFactory implements Job, ApplicationContextAware {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			remindConfigService.saveMessage("", "", "", "", TaskType.projectTaskRemind);
		} catch (Exception e) {
