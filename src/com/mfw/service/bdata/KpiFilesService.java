 ...
 * @author  作者  蒋世平
 * @date 创建时间：2015年12月18日 上午10:01:10
 */
...
public class KpiFilesService {
	 ...
	 *  批量删除由考核模板导入的数据 
	 */
	public void deleteKpiByImportModel(String importCode) throws Exception{
		dao.delete("KpiFilesMapper.deleteKpiByImportModel", importCode);
	}
}
