 ...
 * @author  作者  蒋世平
 * @date 创建时间：2015年12月23日 上午11:21:08
 */
...
public class KpiModelLineService {
	...
	*/
	 ...
	 *  批量删除由考核模板导入的数据 
	 */
	public void deleteModelLineByImportModel(String importCode, String kpiModelId) throws Exception{
		PageData pd = new PageData();
		pd.put("importCode", importCode);
		pd.put("kpiModelId", kpiModelId);
		dao.delete("KpiModelLineMapper.deleteModelLineByImportModel", pd);
	}
}
