package com.mfw.service.system.dictionaries;
 ...
 * 数据字典Service
 * @author  作者 于亚洲
 * @date 创建时间：2014年9月2日 下午17:38:02
 */
...
public class DictionariesService {
	...
	//根据编码查询数据
	public PageData findIdByBm(String BIANMA) throws Exception {
		return (PageData) dao.findForObject("DictionariesMapper.findIdByBm", BIANMA);
